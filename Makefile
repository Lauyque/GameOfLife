...
# Options de liaison
LDFLAGS = -L$(SDL2_DIR)\lib\x64 -L$(SDL2_TTF_DIR)\lib\x64 -L$(SDL2_IMAGES_DIR)\lib\x64  -L$(SDL2_MIXER_DIR)\lib\x64 -lmingw32 -lSDL2main -lSDL2 -lSDL2_ttf -lSDL2_image -lSDL2_mixer -lcomdlg32
